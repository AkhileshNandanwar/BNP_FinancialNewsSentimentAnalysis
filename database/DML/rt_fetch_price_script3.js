...
const API_KEY = 'fdGY2RpRRylXjVCRjM6cV6r6xHA7jezk'; // Replace with your Polygon.io API key
...
// Update portfolio prices every 30 minutes
setInterval(updatePortfolioPrices, 1 * 60 * 1000); // 30 minutes interval
